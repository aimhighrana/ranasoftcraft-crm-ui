...
describe('TimeseriesWidgetComponent', () => {
  ...
  it('transformDataSets(),  transformDataSets', async(() => {
    ...
    const metaData = { widgetId: 123, widgetName: 'test', widgetType: null, objectType: '1005', plantCode: '0', indexName: 'do_workflow', desc: '', isEnableGlobalFilter: false, showTotal: false } as TimeSeriesWidget;
