...
export class Any2tsService {
  ...
  public any2UserDetails(response: any): Userdetails {
    ...
    if (response) {
      ...
      userDetails.plantCode = response.selfServiceUserModel && (response.selfServiceUserModel.ECId ||  response.selfServiceUserModel.ecid ) ? (response.selfServiceUserModel.ECId ||  response.selfServiceUserModel.ecid ) : '0';
